...
- Sprint 2 LEVEL 1 EV/EBITDA: 정규화 EBITDA와 승인된 EV/EBITDA 비교배수가 둘 다 있을 때만 기업가치를 계산한다. EV/Sales 배수를 EV/EBITDA에 쓰지 않는다. DCF·WACC는 하지 않는다.
